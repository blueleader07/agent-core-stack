...
export class AgentCoreStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const urlFetcherFunction = new NodejsFunction(this, 'UrlFetcherFunction', {
      ...
      entry: 'lambda/url-fetcher/index.ts',
      handler: 'handler',
      timeout: cdk.Duration.seconds(30),
      memorySize: 1024, // Increase memory for jsdom
      bundling: {
        minify: false,
        sourceMap: true,
        // Bundle everything - esbuild will handle it
      },
    });
    ...
    const agent = new bedrock.CfnAgent(this, 'ArticleAgent', {
      ...
      foundationModel: 'us.anthropic.claude-sonnet-4-5-20250929-v1:0', // Inference profile ID for Claude Sonnet 4.5
...
Be conversational, insightful, and helpful.`,
    ...
    const agentAlias = new bedrock.CfnAgentAlias(this, 'ArticleAgentAlias', {
      ...
      agentAliasName: 'production-v9', // Use stable Claude 4.5 Sonnet v2 model
    ...
    wsAgentFunction.addToRolePolicy(new iam.PolicyStatement({
      actions: [
        ...
        'bedrock:InvokeAgent', // Some SDK versions use this action
      ],
      resources: ['*'], // Can be tightened to specific agent ARN after it works
    }));
